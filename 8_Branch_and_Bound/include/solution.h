...
public:
   ...
   * @param element_index Element to be added
   ...
   */
  void RemoveElementOnIndex(unsigned solution_index);
   ...
   * @param element_index - Element to find
   ...
   */
  void Show(const string& tag, const string& cpu,
            unsigned iterations = 1,
            unsigned candidate_list_size = 1,
            unsigned nodes_generated = 0,
            bool show_elements = false);
  void ShowMarkdown(const string& tag, const string& cpu,
            unsigned iterations = 1,
            unsigned candidate_list_size = 1,
            unsigned nodes_generated = 0,
            bool show_elements = false);
  void ShowLatex(const string& tag, const string& cpu,
            unsigned iterations = 1,
            unsigned candidate_list_size = 1,
            unsigned nodes_generated = 0,
            bool show_elements = false);
