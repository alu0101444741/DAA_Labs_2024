...
public:
	...
	LOAD(const string& operand, const OperandType& type) : Instruction(operand, type)  { name_ = "LOAD"; };
...
public:
	...
	STORE(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "STORE"; };
...
public:
	...
	READ(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "READ"; };
...
public:
	...
	WRITE(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "WRITE"; };
...
public:
	...
	ADD(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "ADD"; };
...
public:
	...
	SUB(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "SUB"; };
...
public:
	...
	MUL(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "MUL"; };
...
public:
	...
	DIV(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "DIV"; };
...
public:
	/** @brief Constructor for the DIV instruction class. */
	EXP(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "EXP"; };
...
public:
	...
	JUMP(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "JUMP"; };
...
public:
	...
	JZERO(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "JZERO"; };
...
public:
	...
	JGTZ(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "JGTZ"; };
...
public:
	...
	HALT(const string& operand, const OperandType& type) : Instruction(operand, type) { name_ = "HALT"; };
